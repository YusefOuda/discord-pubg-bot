...
def get_stats_embed(username):
    ...
    embed.add_field(name="Top 10 Percentage", value=get_stat(json['Stats'], 'solo', 'WinTop10Ratio'), inline=True)
    ...
    embed.add_field(name="Top 10 Percentage", value=get_stat(json['Stats'], 'duo', 'WinTop10Ratio'), inline=True)
    ...
    embed.add_field(name="Top 10 Percentage", value=get_stat(json['Stats'], 'squad', 'WinTop10Ratio'), inline=True)
