...
def get_stats_text(stats, group, type):
	if type == "stats":
		...
		text += "**Win Pct**: " + get_stat(stats, group, 'WinRatio') + "\n"
		text += "**Top 10 Pct**: " + get_stat(stats, group, 'Top10Ratio')
	elif type == "kills":
		text = "**Total Kills**: " + get_stat(stats, group, 'Kills') + "\n"
		text += "**Most Kills**: " + get_stat(stats, group, 'RoundMostKills') + "\n"
		text += "**K/D Ratio**: " + get_stat(stats, group, 'KillDeathRatio')
	return text
