...
def get_stats_embed(username, region):
	...
	if check_region_group_exists(json_stats["Stats"], "duo", region):
		embed.add_field(name=":couple: __Duo__ :couple:", value="**Wins**: " + get_stat(json_stats["Stats"], "duo", "Wins", "displayValue", region) + " - **Rank**: " + str(get_stat(json_stats["Stats"], "duo", "Rating", "rank", region)), inline=False)
	...
	if check_region_group_exists(json_stats["Stats"], "squad", region):
		embed.add_field(name=":family: __Squad__ :family:", value="**Wins**: " + get_stat(json_stats["Stats"], "squad", "Wins", "displayValue", region) + " - **Rank**: " + str(get_stat(json_stats["Stats"], "squad", "Rating", "rank", region)), inline=False)
